...
retriever_output_dir = "retriever_output"
if not os.path.exists(retriever_output_dir):
    os.mkdir(retriever_output_dir)
...
class RetrieverModel(LightningModule):
    ...
    def validation_epoch_end(self, outputs: List[Dict[str, Any]]) -> None:
        ...
        output_prediction_file = os.path.join(retriever_output_dir, "dev_predictions.json")

        res, res_message = retrieve_evaluate(
            all_logits, all_filename_id, all_ind, output_prediction_file, valid_file, topn=self.topn)
