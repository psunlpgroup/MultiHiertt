...
import retriever_utils as retriever_utils
...
class MHQADataModule(LightningDataModule):
    def __init__(self, 
                transformer_model_name: str,
                batch_size: int = 1, 
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        train_data = MHQADataset(transformer_model_name = self.transformer_model_name,
                                file_path=self.train_file_path,
                                max_instances=self.train_max_instances, 
                                mode="train")
        self.train_data = train_data

        val_data = MHQADataset(transformer_model_name = self.transformer_model_name,
                                file_path=self.val_file_path,
                                max_instances=self.val_max_instances, 
                                mode="valid")
        self.val_data = val_data 
        
        test_data = MHQADataset(transformer_model_name = self.transformer_model_name,
    ...
    def test_dataloader(self):
        ...
        dtloader = DataLoader(self.test_data, batch_size=self.test_batch_size, shuffle=True, drop_last=False, collate_fn=customized_collate_fn, num_workers = self.num_workers)
        return dtloader
    

class MHQAPredictionDataModule(LightningDataModule):
    def __init__(self, 
                transformer_model_name: str,
                batch_size: int = 1, 
                num_workers: int = 8,
    ...
    def test_dataloader(self):
        ...
        dtloader = DataLoader(self.test_data, batch_size=self.batch_size, shuffle=True, drop_last=False, collate_fn=customized_collate_fn, num_workers = self.num_workers)
        return dtloader